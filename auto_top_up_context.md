...
শেষ আপডেট: 2026-08-20 (৩) — **⏸️ ফিচারটা পজড।** §২ক-এ বর্ণিত bKash credential মিসম্যাচ (real production credential PGW-এর জন্য, Tokenized Checkout-এর জন্য না) resolve না হওয়া পর্যন্ত এই dev environment থেকে production-এ Agreement flow-টা আসলেই end-to-end টেস্ট করার কোনো উপায় নেই — user সিদ্ধান্ত নিয়েছেন আপাতত অন্য ফিচারে সময় দেওয়া হবে। কোড, টেস্ট (`SmsCreditAutoRechargeTest.php`), migration — সব ইতিমধ্যে production-এ deployed ও কাজ করছে (feature টা প্রযুক্তিগতভাবে "ready", শুধু ব্যবহারযোগ্য না)। bKash-এর Tokenized Checkout credential হাতে এলে বা sandbox verify করার সুযোগ হলে এখান থেকেই আবার শুরু করা যাবে — নতুন করে ডিজাইন/কোড লেখার দরকার নেই।
