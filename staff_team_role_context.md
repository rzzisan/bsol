...
> **🚨 সেলার সাবডোমেইন — staff-এর জন্য যা জানা দরকার (2026-08-15):** প্রতিটি শপ এখন `{label}.zyrotechbd.com`-এ নিজের ঠিকানা পায়। **সাবডোমেইন Pattern B (owner-only)** — `shop_profiles`-এ থাকে, `owner_only` middleware-এ, staff দাবি বা ছাড়তে পারে না। কিন্তু **staff owner-এর ঠিকানা ব্যবহার করে**: staff প্ল্যাটফর্ম ডোমেইনে লগইন করলে handoff তাকে owner-এর সাবডোমেইনে পাঠায় (`shopOwnerId()` দিয়ে resolve), আর suspended staff exchange-এর সময়ও আবার যাচাই হয়। Onboarding (শপ প্রোফাইল + ঠিকানা) থেকে staff **অব্যাহতিপ্রাপ্ত** — নিজের `ShopProfile` নেই, owner-এরটা ব্যবহার করে। নিরাপত্তা: **কোনো অ্যাকাউন্ট নিজের নয় এমন সাবডোমেইনে লগইন করতে পারে না** (403 `foreign_subdomain`) — staff-ও নয়। বিস্তারিত: `custom_domain_context.md`, CONTEXT.md §৩২।
