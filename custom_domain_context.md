...
- Meta domain verification সেলার নিজে সাবডোমেইনে করতে পারবে কি না — **এখনো যাচাই বাকি** (`tracking_capi_context.md §11.7`)। এটা আর Full/Basic ঠিক করে না, শুধু **AEM/iOS ইভেন্ট প্রায়োরিটি** কনফিগার করা যাবে কি না তা ঠিক করে।
