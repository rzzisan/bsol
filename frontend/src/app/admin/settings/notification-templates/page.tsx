            ...
            <table className="min-w-full border-collapse text-sm">
              <thead className="bg-[var(--accent)] text-white">
                <tr>
                  ...
                  <th className="border border-[var(--border)] px-3 py-2 text-left font-semibold">Channel</th>
                  <th className="border border-[var(--border)] px-3 py-2 text-left font-semibold">{t.form.placeholders}</th>
                  <th className="border border-[var(--border)] px-3 py-2 text-left font-semibold">{t.status}</th>
                  <th className="border border-[var(--border)] px-3 py-2 text-left font-semibold">{t.actions}</th>
                </tr>
              </thead>
              <tbody>
                {loading ? (
                  ...
                  templates.map((row) => (
                    <tr key={row.id} className="bg-[var(--surface)] even:bg-[var(--surface-soft)] hover:bg-[var(--accent)]/10">
                      ...
                      <td className="border border-[var(--border)] px-3 py-2 uppercase">{row.channel}</td>
                      <td className="border border-[var(--border)] px-3 py-2 text-xs">{(row.variables ?? []).join(", ") || "-"}</td>
                      ...
                      <td className="border border-[var(--border)] px-3 py-2">
                        <div className="flex gap-2">
                          <button type="button" onClick={() => beginEdit(row)} className="rounded bg-[var(--accent)] px-2 py-1 text-xs font-semibold text-white">
                            {t.edit}
                          </button>
