...
> - **§11.7a নিষ্পত্তি হয়েছে** — verify করলে সেলারের বিজ্ঞাপন **আটকাবে না** (verification শুধু লিংক-প্রিভিউ সম্পাদনা নিয়ন্ত্রণ করে), তাই apex verify করা হবে। আর Meta **২০২৫-এর জুনে web AEM-এর ম্যানুয়াল কনফিগারেশনই তুলে দিয়েছে**, তাই "per-seller AEM নিয়ন্ত্রণ নেই" — §11.7-এর একমাত্র চিহ্নিত খরচটাও কার্যত অর্থহীন।
>
...
7. ~~**Meta domain verification সাবডোমেইনে কীভাবে কাজ করে**~~ — ✅ **উত্তর পাওয়া গেছে (২০২৬-০৮-১৫), Business Manager-এ সরাসরি পরীক্ষা করে। উত্তর: সেলার পারবে না।**
   ...
   **সূত্রের মান ও একটা ৩০-সেকেন্ডের নিশ্চিতকরণ:** link-editing scope Meta-র **নিজের** ডক থেকে নিশ্চিত। AEM অপসারণের খবরটা একাধিক স্বতন্ত্র তৃতীয়-পক্ষ সূত্রে মিলছে, কিন্তু Meta-র নিজের পাতা থেকে সরাসরি যাচাই করা যায়নি। **Events Manager খুলে দেখুন "Aggregated Event Measurement" ট্যাবটা আছে কি না** — না থাকলেই নিশ্চিত।
