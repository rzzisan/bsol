...
> - **নতুন খোলা প্রশ্ন §11.7a** — apex verify করার পর সেলাররা নিজের সাবডোমেইনে বিজ্ঞাপন চালাতে partner-assignment লাগবে কি না। **উত্তর না জানা পর্যন্ত verify করা হবে না**; CAPI-র জন্য দরকার নেই, T6-এর আগে সিদ্ধান্ত।
>
...
7. ~~**Meta domain verification সাবডোমেইনে কীভাবে কাজ করে**~~ — ✅ **উত্তর পাওয়া গেছে (২০২৬-০৮-১৫), Business Manager-এ সরাসরি পরীক্ষা করে। উত্তর: সেলার পারবে না।**
   ...
   **Partner sharing কী দেয় — যাচাই হয়েছে (২০২৬-০৮-১৫):** "Share this Domain with a partner" ডায়ালগে partner business ID ছাড়া **একটাই টগল: "Link to domain"** — *"Add a link to this domain in your ads, and customize the text or creative content that links to this domain."* AEM বা event configuration-এর **কোনো অপশন নেই**। অর্থাৎ partner sharing = **বিজ্ঞাপনে লিংক দেওয়ার অধিকার**, AEM নয়। AEM আমাদের হাতেই থাকে।
   ...
   ### ⚠️ 11.7a — verify করার আগে যা জানতেই হবে (নতুন, খোলা)

   ওই টগলের অস্তিত্বই বলছে **verified ডোমেইনে বিজ্ঞাপনের লিংক দেওয়া একটা অনুমতি-নিয়ন্ত্রিত ব্যাপার**। তাই প্রশ্ন:

   > `zyrotechbd.com` verify করার পর সেলার তার নিজের `{seller}.zyrotechbd.com`-এ বিজ্ঞাপন চালাতে পারবে কি না, নাকি আগে তার Business ID partner হিসেবে যোগ করতে হবে?

   - **যোগ করতে না লাগলে** → verify করাই ভালো, AEM ফ্রি-তে পাওয়া যায়, per-seller কাজ শূন্য।
   - **যোগ করতে লাগলে** → **প্রতিটি নতুন সেলারের জন্য Business Manager-এ ম্যানুয়াল ধাপ**, ঠিক যে জিনিসটা এড়াতে পুরো সাবডোমেইন ডিজাইন (§8.6) করা হয়েছিল। তখন হিসাবটা উল্টে যায়: বাংলাদেশি ট্রাফিকের অধিকাংশ Android, তাই AEM-এর লাভ সীমিত, অথচ খরচটা প্রতি-সেলারে চিরস্থায়ী।

   **সিদ্ধান্ত: এখনই verify করা হবে না।** domain verification **CAPI-র জন্য দরকার নেই** — T1/T2/T5 সবই এটা ছাড়া সম্পূর্ণ কাজ করে। **T6-এর আগে** উপরের প্রশ্নটার উত্তর নিয়ে তখন সিদ্ধান্ত নেওয়া হবে। আগেভাগে verify করে ফেললে, যদি partner-যোগ বাধ্যতামূলক হয়, তাহলে চালু সেলারদের বিজ্ঞাপন হঠাৎ আটকে যেতে পারে — **উল্টো করা কঠিন, তাই আগে জানা দরকার**।
