...
| 9 | সেলার স্টোরফ্রন্ট (ফুল ইকমার্স শপ) | 🟡 S0-S6 + S3b + S8 ✅ সবগুলো লাইভ, real order + real sitemap/JSON-LD দিয়ে end-to-end ভেরিফাইড (২০২৬-০৮-২১) — বাকি S7 (রিভিউ), S9 (ট্র্যাকিং) | `seller_storefront_context.md` |
