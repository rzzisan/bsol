...
| **P2** | Payment gateway sandbox verification (Nagad Merchant, EPS) | 🟡 আংশিক (২০২৬-০৮-২৮ status ঠিক করা হলো) — **EPS ✅ ইতিমধ্যে real sandbox দিয়ে live verify হয়ে গেছে** (২০২৬-০৮-১৯, ব্যবহারকারীর নিজের test card, real bug পাওয়া+ফিক্স হয়েছে, `online_payment_context.md §৯.১`) — এই row আগে ভুলভাবে "Not started" বলছিল। **Nagad Merchant এখনো ⬜ unconfirmed** — verify()-এর raw response এখন success/failure দুই path-ই log করে (২০২৬-০৮-২৮ hardening, `NagadMerchantGatewayClient::verifyPayment()`), কিন্তু আসল sandbox test ছাড়া field-shape নিশ্চিত হবে না — real Nagad merchant sandbox account/credential দরকার | `online_payment_context.md §১১`, `production_audit_report_context.md §৭` |
