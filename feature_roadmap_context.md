...
| 1 | চেকআউটে অনলাইন পেমেন্ট কালেকশন | 🟡 আংশিক — Phase A (personal wallet, মার্চেন্ট একাউন্ট ছাড়াই) ও Phase B1 (SSLCommerz merchant gateway) ✅ সম্পন্ন ও লাইভ (২০২৬-০৮-১৮); বাকি ৬টা gateway (AamarPay/ZiniPay/ShurjoPay/EPS/bKash Merchant/Nagad Merchant) ধাপে ধাপে বাকি | `online_payment_context.md` |
